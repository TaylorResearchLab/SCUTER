...
1. **Download the actual `.skill` file to your computer:** [download `scuter-v0.2.2-dev.skill`](https://raw.githubusercontent.com/TaylorResearchLab/SCUTER/a6e1d7a76569caac9ddb47eb73ebc5fbb983347e/dist/scuter-v0.2.2-dev.skill).
